...
@ActiveProfiles("test")
@ContextConfiguration(classes = {TestAppConfig.class, ObtenerClientesKPIIntegrationTest.Configuration.class, ClienteController.class})
class ObtenerClientesKPIIntegrationTest extends TestBase {
