...
@ActiveProfiles("test")
@ContextConfiguration(classes = {AppConfigTests.class, ObtenerListaClientesIntegrationTest.Configuration.class, ClienteController.class})
class ObtenerListaClientesIntegrationTest extends BaseTest {
